...
public class Controller {
    ...
    public PN opretPNOrdination(LocalDate startDen, LocalDate slutDen,
        ...
        if (startDen.isAfter(slutDen)) {
            throw new IllegalArgumentException("Start dato kan ikke være før, Slut dato");
        }
        ...
        throw new RuntimeException("Oridination ikke oprettet, mangler info");
    }
    ...
    public DagligFast opretDagligFastOrdination(LocalDate startDen,
        ...
        if (patient != null && laegemiddel != null && (morgenAntal + middagAntal + aftenAntal + natAntal) >= 0) {
